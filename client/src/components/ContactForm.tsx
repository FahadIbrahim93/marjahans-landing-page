      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-16 space-y-4">
          ...
          <p className="text-slate-400 max-w-2xl mx-auto text-lg">
            Have questions about our collection? Reach out to us and our team
            will assist you
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          <div className="space-y-8">
            <div>
              ...
              <p className="text-slate-400 mb-6">
                Get in touch with our team for inquiries about our jewelry
                collection, custom orders, or any other questions.
              </p>
            </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <a
                  href="mailto:marjahans@gmail.com"
            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-4">
                <a
                  href="#"
                  className="text-slate-400 hover:text-amber-400 transition-colors text-sm uppercase tracking-widest"
                >
                  Instagram
                </a>
                <a
          ...
          <form
            ...
            className="space-y-6 lux-card p-6 rounded-2xl"
          >
            <div className="space-y-2">
              <label
                htmlFor="name"
