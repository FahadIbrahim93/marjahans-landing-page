...
export default function AdminDashboard() {
  ...
  const waitingChats = conversations?.filter((c: any) => c.status === 'waiting').length || 0;
          ...
          <TabsContent value="facebook" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Sync products from your Facebook Shop to your e-commerce catalog</CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h4 className="font-semibold text-blue-900">Sync Status</h4>
                      {syncStatus.isRunning ? (
                        ...
                        <p className="text-sm text-blue-700 mt-1">No sync performed yet. Click "Start Sync" to begin.</p>
                      )}
                    </div>
                  </div>
                </div>
                ...
                {syncStatus.syncedCount > 0 && (
                  <div className="grid grid-cols-3 gap-4 pt-4 border-t">
                    <div className="text-center">
                      <div className="text-2xl font-bold text-green-600">{syncStatus.syncedCount}</div>
                      <p className="text-sm text-gray-600">Successfully Synced</p>
                    </div>
                    <div className="text-center">
                      <div className="text-2xl font-bold text-gray-600">{syncStatus.productCount}</div>
                ...
                {syncStatus.syncedCount > 0 && (
                  <div className="pt-4 border-t">
                    <h4 className="font-semibold mb-3">Recently Synced Products</h4>
                  ...
                  {conversations && conversations.length > 0 ? (
                    conversations.map((conv: any) => (
                      ...
                      >
                        ...
                        {conv.status === 'waiting' && (
                          <p className="text-xs text-red-600 font-semibold mt-1">⚠ Waiting for response</p>
                        )}
                      </button>
                    ))
                  ) : (
          ...
          <TabsContent value="settings" className="space-y-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Manage your Facebook Shop integration</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                ...
                <div>
                  <label className="block text-sm font-semibold text-gray-900 mb-2">Auto-sync Interval</label>
