...
import { categories, products, productImages, productVariants } from './drizzle/schema';
...
const DATABASE_URL = process.env.DATABASE_URL || 'mysql://root:@localhost/marjahans';
